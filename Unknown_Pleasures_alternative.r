    ...
    y[i,] <- (dnorm(x+runif(1,-1,1),mean = runif(1, -5,5), sd = 1, log = F)*runif(m, 1.8,2)/ runif(1, 0.9,3) + dlogis(x+runif(1,-1,1),location = runif(1,-5,5), scale = runif(1,1,1.5), log = FALSE)*runif(m, 1.9,2) / runif(1, 0.9,7) + dlogis(x+runif(1,-1,1),location = runif(1,-5,5), scale = runif(1,1,1.5), log = FALSE)*runif(m, 1.9,2) / runif(1, 0.9,7) + dlogis(x+runif(1,-1,1),location = runif(1,-5,5), scale = runif(1,1,1.5), log = FALSE)*runif(m, 1.9,2) / runif(1, 0.9,7) + dlogis(x+runif(1,-1,1),location = runif(1,-5,5), scale = runif(1,1,1.5), log = FALSE)*runif(m, 1.9,2) / runif(1, 0.9,7)) *runif(x, 0.85,1)/runif(1, 1.5,5)
